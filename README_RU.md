...
- Xray-core собирается из исходников воркфлоу этого репозитория, на свежем стабильном Go и с теми же флагами сборки, что и в апстриме. Готовые бинарники публикуются в релизы `stable` и `alpha` этого репозитория, откуда их и забирает Docker build.
